...
public class CarShowroomClient {
    ...
    private static final String PROFIT_FILE = "SHOWROOM_PROFIT.txt";
    ...
    private static void bookCar(Statement stmt) throws SQLException {
        ...
        if (checkShowroomExists(stmt, showroomName)) {
            ...
            String getCarPriceSql = "SELECT price FROM " + showroomName + " WHERE car_id = " + carId;
            ...
            if (priceResult.next()) {
                ...
                if (rowsAffected > 0) {
                    ...
                    System.out.println("Car booked successfully.");
                     writeProfitToFile(showroomName + "," + carPrice );
    ...
    private static void writeProfitToFile(String data) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(PROFIT_FILE, true))) {
            writer.write(data);
            writer.newLine();
        } catch (IOException e) {
            e.printStackTrace();
